...
int main() {
	...
	std::cout << "\nValor final de i: " << i;
	std::cout << "\nValor final de j: " << j; //não está definido pq foi declarado dentro do for. Não é global
	...
	// Logo quando este bloco de código chegar ao fim a variável j que é local a este bloco, será destruída e 
	// não mais estará acessível. Ela (j) somente é acessível dentro do comando for 
