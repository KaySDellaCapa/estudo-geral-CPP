...
int SomaAUmNumero(int Numero, int NumeroASerSomado) // Criando a função
{
	return Numero + NumeroASerSomado;
}

void Mensagem() // Criando uma função
{
...
int main()
{
	...
	RetornoDaFuncao = SomaAUmNumero(200, -500); // Chamando a função
